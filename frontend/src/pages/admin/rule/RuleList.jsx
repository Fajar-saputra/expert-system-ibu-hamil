...
import { getRules, deleteRule } from "../../../features/rules/ruleSlice";
...
const RuleList = () => {
    ...
    const { rules, isLoading, isError, message } = useSelector(
        (state) => state.rule
    );
                                    ...
                                    <td className="py-4 px-6">
                                        <div className="flex flex-wrap gap-1">
                                            {r.gejala.map((g) => (
                                                <span
                                                    key={g._id}
                                                    className="bg-green-100 text-green-700 text-xs px-2 py-1 rounded border"
                                                >
                                                    {g.kode}
                                                </span>
                                            ))}
