    ...
    return (
        <div className="container">
            ...
            <form onSubmit={onSubmit}>
                <div>
                    <label>Email</label>
                    <input type="email" id="email" name="email" value={email} onChange={onChange} placeholder="Masukkan email" required />
                </div>
                <div>
                    <label>Password</label>
                    <input type="password" id="password" name="password" value={password} onChange={onChange} placeholder="Masukkan password" required />
                </div>
