            ...
            <div className="bg-white rounded-[2.5rem] shadow-2xl max-w-2xl w-full overflow-hidden border border-gray-50">
                ...
                <div className="p-10 md:p-12">
                    ...
                    <div className="space-y-6">
                        <div className="text-gray-600 leading-relaxed bg-gray-50 p-6 rounded-2xl border-l-4 border-indigo-200">
                        ...
                        <div className="p-6 bg-amber-50 rounded-2xl border border-amber-100 flex gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-amber-800 text-jus">{result.penyakit.solusi}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-10 flex flex-col sm:flex-row gap-4">
                        ...
                        <Link
                            to="/"
                            className="flex-1 flex items-center justify-center text-gray-500 font-bold hover:text-[#7C74EE] transition-colors"
                        >
                            Kembali ke Home
                        </Link>
                    </div>
                    ...
                    <p className="text-center text-[10px] text-gray-400 mt-8 uppercase tracking-widest">
                        *Hasil ini hanyalah skrining awal, silakan hubungi dokter untuk diagnosis medis resmi.
                    </p>
                </div>
            </div>
        </div>
